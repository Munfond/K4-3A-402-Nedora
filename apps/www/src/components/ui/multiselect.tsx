/** biome-ignore-all lint/correctness/useExhaustiveDependencies: shadcn component defaults */
/** biome-ignore-all lint/a11y/noStaticElementInteractions: shadcn component defaults */
/** biome-ignore-all lint/a11y/useKeyWithClickEvents: shadcn component defaults */
"use client";
      ...
      >
        <div className="flex flex-wrap gap-1">
          {selected.map((option) => {
            ...
            if (pill) {
              return <React.Fragment key={option.value}>{pill}</React.Fragment>;
            }

    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "right" &&
            "data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-3 right-3 h-[(calc(100svh-12px))] w-[calc(100%-1.5rem)] rounded-2xl border-l sm:max-w-sm",
          side === "left" &&
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "mt-auto flex shrink-0 flex-col gap-2 border-t border-t-neutral-100 p-2",
        className,
      )}
      {...props}
    />
